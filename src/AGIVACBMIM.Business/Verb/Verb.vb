Friend Class Verb
    ...
    ReadOnly Property Executor As Action(Of ICharacter, IReadOnlyDictionary(Of String, Integer))
    Sub New(name As String, parameters As IReadOnlyDictionary(Of String, Integer), executor As Action(Of ICharacter, IReadOnlyDictionary(Of String, Integer)))
    ...
    Public ReadOnly Property Parameter(parameterName As String) As Integer Implements IVerb.Parameter
        ...
        End Get
    End Property
    Public Sub Execute(character As ICharacter) Implements IVerb.Execute
        Executor.Invoke(character, Parameters)
    End Sub
End Class
